...
public class TransactionsService {
    ...
    public void performTransfer(int senderId, int receiverId, int amount) {
        ...
        Transaction debitTransaction = new Transaction(id, receiver, sender, Transaction.Category.DEBIT, -amount);
        Transaction creditTransaction = new Transaction(id, sender, receiver, Transaction.Category.CREDIT, amount);
